...
' || ||  \V/\V/ ||___ \_))  \\_//  ||    | ||___ || \\  \\_//  
'--------------------------------------------------------------
'------ super awesome and easy database context ---------------
...
Partial Class DataContext
    ...
    Shared Function Current(ByVal Updatable As Boolean) As DataContext
        ...
        If myConnection IsNot Nothing Then
            ...
            Dim oDC As New DataContext("SERVER=" & myConnection.DatabaseServer & ";DATABASE=" & myConnection.Database &
                                        ";UID=" & myConnection.DatabaseUsername & ";PWD=" & myConnection.DatabasePassword &
